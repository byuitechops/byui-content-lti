  ...
  g("0", [], function() {
    return function(a) {
      function b() {
        ...
        function d(a) {
          var b = null;
          return a && a.id && g.tinymce && (b = i().get(a.id)),
          b
        }
        function e(a) {
        ...
        f.each([
          ...
          f.fn[g] = function(a) {
            ...
            if (a !== c)
              return b.call(g.filter(":tinymce"), a),
            ...
            return (j
              ? g
              : g.eq(0)).each(function(a, b) {
              var c = d(b);
              h += c
                ? j
                  ? c.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "")
                  : c.getContent({
                    save: !0
                  })
                : i.apply(f(b), k)
        ...
        f.each([
          ...
          f.fn[b] = function(a) {
            ...
            return e(b)
              ? a !== c
                ? ("string" == typeof a && b.filter(":tinymce").each(function(b, c) {
                  var e = d(c);
                  e && e.setContent(i
                    ? a + e.getContent()
                    : e.getContent() + a)
                }), g.apply(b.not(":tinymce"), arguments), b)
                : void 0
              : g.apply(b, arguments)
          }
        }),
        ...
        f.fn.attr = function(a, g) {
          ...
          if (!a || "value" !== a || !e(i))
            return g !== c
              ...
              : h.attr.apply(i, j);
          if (g !== c)
            return b.call(i.filter(":tinymce"), g),
      ...
      f.fn.tinymce = function(a) {
        function c() {
          ...
          m.each(function(b, e) {
            ...
            i().get(g) || (f = i().createEditor(g, a), c.push(f), f.on("init", function() {
              var a,
                b = h;
              m.css("visibility", ""),
              h && ++d == c.length && ("string" == typeof b && (a = b.indexOf(".") === -1
                ? null
                : i().resolve(b.replace(/\.\w+$/, "")), b = i().resolve(b)), b.apply(a || i(), c))
            }))
          }),
        ...
        if (!a)
          return i()
            ? i().get(m[0].id)
            : null;
        if (m.css("visibility", "hidden"), g.tinymce || d || !(j = a.script_url))
          1 === d
            ? h.push(c)
            : c();
        else {
          ...
          g.tinymce = g.tinyMCEPreInit || {
            base: k,
            suffix: n
          },
          j.indexOf("gzip") != -1 && (l = a.language || "en", j = j + (/\?/.test(j)
            ? "&"
            : "?") + "js=true&core=true&suffix=" + escape(n) + "&themes=" + escape(a.theme || "modern") + "&plugins=" + escape(a.plugins || "") + "&languages=" + (l || ""), g.tinyMCE_GZ || (g.tinyMCE_GZ = {
            start: function() {
              function b(a) {
          ...
          o.onload = o.onreadystatechange = function(b) {
            b = b || window.event,
            2 === d || "load" != b.type && !/complete|loaded/.test(o.readyState) || (i().dom.Event.domLoaded = 1, d = 2, a.script_loaded && a.script_loaded(), c(), f.each(h, function(a, b) {
              b()
            }))
          },
          o.src = j,
      ...
      f.extend(f.expr[":"], {
        tinymce: function(a) {
          var b;
          return !!(a.id && "tinymce" in g && (b = i().get(a.id), b && b.editorManager === i()))
        }
      })
    }
  }),
